        ...
        <div className="min-h-screen bg-[#0a0a0f] text-white font-sans antialiased selection:bg-indigo-500/30 selection:text-indigo-200">
            ...
            <header className="sticky top-0 z-50 w-full border-b border-white/[0.05] bg-[#0a0a0f]/70 backdrop-blur-md">
                <div className="max-w-7xl mx-auto h-16 px-6 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        {user ? (
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link
                                    href="/dashboard"
                                    className="flex items-center gap-2 py-2 px-3.5 bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.08] rounded-lg text-xs font-bold transition-all no-underline text-white/80 hover:text-white"
                                >
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className="flex items-center gap-2.5 py-1.5 px-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.07] transition-all cursor-pointer"
                                    >

                                        <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#6366f1] to-[#10b981] flex items-center justify-center text-[11px] font-black text-white shrink-0">
                                            {initials}
                                        </div>
                                        <div className="text-left">
                                            <p className="text-[12px] font-bold text-white leading-tight">{user.name}</p>
                                            <p className="text-[10px] text-white/35 font-mono leading-tight">{user.email}</p>
                                        </div>
                                    ...
                                    {userMenuOpen && (
                                        <>
                                            ...
                                            <div className="absolute right-0 top-full mt-2 w-52 bg-[#111118] border border-white/[0.08] rounded-xl shadow-[0_16px_40px_rgba(0,0,0,0.6)] z-20 overflow-hidden py-1.5">
                                                {/* User info header */}
                                                <div className="px-4 py-2.5 border-b border-white/[0.06] mb-1">
                                                    <p className="text-[12px] font-bold text-white">{user.name}</p>
                                                    <p className="text-[10px] text-white/35 font-mono truncate">{user.email}</p>
                                                </div>
                                                ...
                                                <DropdownLink href="/dashboard/profile" icon={
                                                ...
                                                <button
                                                    ...
                                                    className="w-full flex items-center gap-2.5 px-4 py-2 text-[12px] font-semibold text-red-400/80 hover:text-red-400 hover:bg-red-500/[0.06] transition-colors cursor-pointer bg-transparent border-0 text-left"
                                                >
                                                    <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            /* ── Logged-out state ── */
                            <>
                                <Link href="/login" className="text-sm font-semibold text-white/60 hover:text-white transition-colors no-underline">
                                    Sign In
                                </Link>
                                <Link href="/register" className="py-2 px-4 bg-gradient-to-br from-[#6366f1] to-[#4f46e5] hover:opacity-90 rounded-lg text-xs font-bold transition-all no-underline shadow-[0_4px_12px_rgba(99,102,241,0.25)] text-white">
                                    Get Started
                                </Link>
                            </>
                        )}
                    ...
                    {/* Mobile hamburger */}
                    <button
                        className="flex md:hidden bg-transparent border-0 text-white/70 p-1 cursor-pointer"
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden border-t border-white/[0.05] bg-[#0a0a0f] px-5 py-4 space-y-1 flex flex-col">
                        {/* Nav links */}
                        {["features", "architecture", "pricing"].map((id) => (
                            <a
                                ...
                                className="py-2.5 px-3 rounded-lg text-sm font-medium text-white/50 hover:text-white hover:bg-white/[0.03] transition-colors no-underline capitalize"
                            >
                                {id}
                            </a>
                        ))}
                        ...
                        {user ? (
                            ...
                            <>
                                ...
                                <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/[0.03] border border-white/[0.06] mb-1">
                                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#6366f1] to-[#10b981] flex items-center justify-center text-[11px] font-black text-white shrink-0">
                                        {initials}
                                    </div>
                                ...
                                <Link href="/dashboard" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2.5 py-2.5 px-3 rounded-lg text-sm font-semibold text-white/70 hover:bg-white/[0.03] hover:text-white no-underline transition-colors">
                                ...
                                <Link href="/dashboard/upload" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2.5 py-2.5 px-3 rounded-lg text-sm font-semibold text-white/70 hover:bg-white/[0.03] hover:text-white no-underline transition-colors">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z" /></svg>
                                    Upload Files
                                </Link>
                                <Link href="/dashboard/profile" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2.5 py-2.5 px-3 rounded-lg text-sm font-semibold text-white/70 hover:bg-white/[0.03] hover:text-white no-underline transition-colors">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2.5 w-full py-2.5 px-3 rounded-lg text-sm font-semibold text-red-400/80 hover:bg-red-500/[0.05] hover:text-red-400 transition-colors cursor-pointer bg-transparent border-0 text-left"
                                >
                            ...
                            /* ── Mobile logged-out ── */
                            <>
                                <Link href="/login" onClick={() => setMobileMenuOpen(false)} className="py-2.5 px-3 text-sm font-semibold text-white/60 no-underline hover:text-white transition-colors">
                                    Sign In
                                </Link>
                                <Link href="/register" onClick={() => setMobileMenuOpen(false)} className="py-2.5 text-center bg-gradient-to-br from-[#6366f1] to-[#4f46e5] rounded-xl text-xs font-bold no-underline text-white shadow-md">
                                    Get Started Free
                                </Link>
                            </>
                        )}
            ...
            <section className="relative max-w-7xl mx-auto px-6 pt-24 pb-20 text-center overflow-hidden">
                ...
                <h1 className="text-4xl sm:text-6xl font-black tracking-tight max-w-3xl mx-auto leading-[1.1] mb-6">
                    Decentralized Cloud Ingestion &{" "}
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#818cf8] via-[#6366f1] to-[#10b981]">
                        Secure Storage Pool
                    </span>
                </h1>
            ...
            <section id="pricing" className="max-w-4xl mx-auto px-6 py-20 border-t border-white/[0.04]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white/[0.015] border border-white/[0.06] rounded-2xl p-6 relative flex flex-col justify-between">
                        ...
                        <Link href={user ? "/dashboard" : "/register"} className="w-full text-center mt-6 py-2 bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.08] text-xs font-bold rounded-lg text-white no-underline transition-all">
                            {user ? "Go to Dashboard" : "Initialize Free Core"}
                        </Link>
                    </div>
                    <div className="bg-gradient-to-b from-indigo-500/[0.03] to-transparent border border-indigo-500/30 rounded-2xl p-6 relative flex flex-col justify-between shadow-[0_10px_30px_rgba(99,102,241,0.05)]">
                        ...
                        <Link href={user ? "/dashboard" : "/register"} className="w-full text-center mt-6 py-2 bg-gradient-to-r from-[#6366f1] to-[#4f46e5] text-xs font-bold rounded-lg text-white no-underline transition-all shadow-md">
                            {user ? "Go to Dashboard" : "Deploy Production Asset"}
                        </Link>
                    </div>
                </div>
            </section>
...
function DropdownLink({
    ...
    return (
        <Link
            href={href}
            onClick={onClick}
            className="flex items-center gap-2.5 px-4 py-2 text-[12px] font-semibold text-white/60 hover:text-white hover:bg-white/[0.04] transition-colors no-underline"
        >
